      ...
      <Box borderRadius="10px" bgColor="gray.100" height="fit-content">
        ...
        <Box w="100%" p="16px 24px">
          ...
          >
            <Flex
              ...
              alignItems="center"
            >
              {/* <Text fontSize="0.9rem" fontWeight="500">Arvind</Text> */}
        ...
        <Box maxH="50rem" overflowY="auto" px="24px" pb="24px">
          <DataCard title="Requisition Details">
            <KeyValue
              title="Urgency"
              value={urgencyOptions && requisitionDetails ? urgencyOptions.find((item) => item.value === requisitionDetails.urgency)?.label : ''}
            />

            <KeyValue
              title="Gender"
              value={genderOptions && requisitionDetails ? genderOptions.find((item) => item.value === requisitionDetails.gender)?.label : ''}
            />
